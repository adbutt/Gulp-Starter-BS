...
module.exports = {
	...
	// Project options.
	project: 'WPGStarter', // Project Name.
	projectURL: 'wpgstarter.dev', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:8888.
